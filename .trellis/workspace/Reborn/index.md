...
|---|------|-------|---------|--------|
| 69 | 2026-05-28 | Block save CTA until export preview ready + MD3 disabled tokens | `c9ab52d` | `main` |
...
| 40 | 2026-05-19 | 修复宫格切图 1080x1440 EXIF 压扁 + 沉淀跨层 Gotcha | `81ee65b`, `abb72f4`, `cbed641` | `main` |
...
| 1 | 2026-05-07 | Bootstrap Guidelines - populate frontend spec | `31fdc84` | `main` |
<!-- @@@/auto:session-history -->
